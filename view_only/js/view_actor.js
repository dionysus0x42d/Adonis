...
async function performSearch() {
    try {
        ...
        // 構建排序物件
        const sort = {
            field: state.filters.sort,
            order: state.filters.sort_order
        };
        ...
        // 從 IndexedDB 查詢資料
        const result = await GVDBData.getActors(filters, sort, pagination);
        ...
        renderActorsList(formattedResult.results);
        renderPagination(formattedResult);
        updateResultCount(formattedResult.total);
